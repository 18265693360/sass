...
describe('class Mime', function() {
  ...
  it('getType()', function() {
    ...
    assert.equal(mime.getType('.txt'), 'text/plain');
    assert.equal(mime.getType('txt'), 'text/plain');
    assert.equal(mime.getType('/path/to/pages.html'), 'text/html');
    assert.equal(mime.getType('c:\\path\\to\\pages.html'), 'text/html');
    assert.equal(mime.getType('page.html'), 'text/html');
    assert.equal(mime.getType('path/to/pages.html'), 'text/html');
    assert.equal(mime.getType('path\\to\\pages.html'), 'text/html');
