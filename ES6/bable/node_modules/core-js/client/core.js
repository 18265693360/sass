...
var $export = function (type, name, source) {
  ...
  for (key in source) {
    ...
    // bind timers to globalCss for call from export context
...
module.exports = function () {
  ...
  // - setTimeout
    ...
    notify = function () {
      // strange IE + webpack dev server bug - use .call(globalCss)
...
__webpack_require__(62)('split', 2, function (defined, SPLIT, $split, maybeCallNative) {
  ...
  if (
    ...
    internalSplit = function (separator, limit) {
      ...
      // Make `globalCss` and avoid `lastIndex` issues by working with a copy
